package test.cn.bdqfork.ioc.jdk.scope.setter;
...
public class TestSetterInject {
    ...
    public void testJdkSetterInject() throws ApplicationContextException {
        ApplicationContext applicationContext = new AnnotationApplicationContext("test.cn.bdqfork.ioc.jdk.scope.setter");
